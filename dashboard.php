...
<body class="bg-gradient-to-r from-[#48A6A7] to-[#9ACBD0]">
  ...
  <header class="bg-[#006A71] py-4">
    <div class="max-w-7xl mx-auto px-6 flex justify-between items-center">
      ...
      <nav class="hidden md:flex space-x-6 text-[#F2EFE7] text-sm font-medium">
        ...
        <a href="#explore-careers" class="flex items-center gap-2 hover:text-[#9ACBD0] hover:border-b-2 hover:border-[#9ACBD0] active:border-b-2 active:border-[#9ACBD0] transition-all duration-700">
      ...
      <a href="signup.php" class="text-[#F2EFE7] border border-[#F2EFE7] px-4 py-2 rounded hover:bg-[#9ACBD0] hover:text-black transition flex items-center gap-2">
  ...
  <section class="py-20" id="home">
    <div class="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center">
      <div class="md:w-1/2 mb-12 md:mb-0" data-aos="fade-right" data-aos-duration="1000">
        ...
        <p class="text-lg text-[#2A4365] mb-6" data-aos="fade-right" data-aos-delay="200">
        ...
        <div class="flex space-x-4" data-aos="fade-right" data-aos-delay="400">
          <a href="signup.php">
            <button class="bg-[#F2EFE7] hover:bg-[#9ACBD0] text-[#006A71] font-bold px-6 py-3 rounded-lg transition btn-hover">
              Get Started
            </button>
          </a>
          <a href="#features">
            <button
              class="border border-[#48A6A7] bg-[#F2EFE7] hover:bg-[#9ACBD0] text-[#006A71] font-semibold px-6 py-3 rounded-lg transition btn-hover">
              Learn More
            </button>
          </a>
        </div>
  ...
  <div class="max-w-7xl mx-auto px-6">
    <h2 class="text-4xl font-bold text-center text-[#006A71] mb-12" data-aos="fade-up">Explore Your Career Path</h2>
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
      <div class="bg-yellow-50 p-8 rounded-xl shadow-lg card-hover" data-aos="fade-up" data-aos-delay="100">
      ...
      <div class="bg-yellow-50 p-8 rounded-xl shadow-lg card-hover" data-aos="fade-up" data-aos-delay="200">
      ...
      <div class="bg-yellow-50 p-8 rounded-xl shadow-lg card-hover" data-aos="fade-up" data-aos-delay="300">
  ...
  <section id="about" class="py-20">
    <div class="max-w-7xl mx-auto px-6 text-center">
      <h2 class="text-3xl font-bold text-[#006A71] mb-4" data-aos="fade-up">About CopeUp</h2>
      <p class="text-[#2A4365] text-lg mb-8" data-aos="fade-up" data-aos-delay="200">
      ...
      <div class="grid md:grid-cols-3 gap-8 text-left">
        <!-- 6 Info Cards -->
        <div class="bg-yellow-50 p-6 rounded-xl shadow-lg card-hover" data-aos="fade-up" data-aos-delay="200">
          <h3 class="text-xl font-semibold text-[#006A71] mb-2">
            <i class="fas fa-robot text-[#006A71]"></i> What We Do
          </h3>
          <p class="text-[#2A4365]">We analyze your interests, skills, personality, and goals to recommend career options, suitable courses, colleges, and industry insights — all on a personalized AI dashboard.</p>
        </div>
        <div class="bg-yellow-50 p-6 rounded-xl shadow-lg card-hover" data-aos="fade-up" data-aos-delay="300">
          <h3 class="text-xl font-semibold text-[#006A71] mb-2">
            <i class="fas fa-bullseye text-[#48A6A7]"></i> Our Mission
          </h3>
          <p class="text-[#2A4365]">Our mission is to bridge the gap between ambition and action by providing accessible, accurate, and tailored career advice — anytime, anywhere.</p>
        </div>
        <div class="bg-yellow-50 p-6 rounded-xl shadow-lg card-hover" data-aos="fade-up" data-aos-delay="400">
          <h3 class="text-xl font-semibold text-[#006A71] mb-2">
            <i class="fas fa-users text-[#9ACBD0]"></i> Who It's For
          </h3>
          <p class="text-[#2A4365]">Whether you're a high school student choosing a stream, a college student exploring jobs, or a professional switching careers — CareerGuideAI is built for you.</p>
          <p class="text-[#2A4365] body-font">Whether you're a high school student choosing a stream, a college student exploring jobs, or a professional switching careers — CareerGuideAI is built for you.</p>
        </div>
        <div class="bg-yellow-50 p-6 rounded-xl shadow-lg card-hover" data-aos="fade-up" data-aos-delay="500">
          <h3 class="text-xl special-font font-semibold text-[#006A71] mb-2">
            <i class="fas fa-brain text-[#006A71]"></i> How It Works
          </h3>
          <p class="text-[#2A4365] body-font">Through a series of assessments and AI-powered analysis, we generate real-time insights and match you with careers, courses, mentors, and resources that align with your strengths.</p>
        </div>
        <div class="bg-yellow-50 p-6 rounded-xl shadow-lg card-hover" data-aos="fade-up" data-aos-delay="600">
          <h3 class="text-xl special-font font-semibold text-[#006A71] mb-2">
            <i class="fas fa-lightbulb text-[#48A6A7]"></i> Why Choose Us
          </h3>
          <p class="text-[#2A4365] body-font">Unlike generic career portals, we offer dynamic guidance that evolves with your growth, giving you control and clarity over your future.</p>
        </div>
        <div class="bg-yellow-50 p-6 rounded-xl shadow-lg card-hover" data-aos="fade-up" data-aos-delay="700">
          <h3 class="text-xl special-font font-semibold text-[#006A71] mb-2">
            <i class="fas fa-rocket text-[#9ACBD0]"></i> Future Ready
          </h3>
          <p class="text-[#2A4365] body-font">We stay updated with industry trends, future skills, and global job data — so your journey is always aligned with what's next.</p>
        </div>
      </div>
    </div>
  </section>
  ...
  <section id="contact" class="py-20">
    <div class="max-w-7xl mx-auto px-6 text-center">
      <h2 class="text-3xl heading-font font-bold text-[#006A71] mb-4" data-aos="fade-up">Contact Us</h2>
      <p class="text-[#2A4365] body-font mb-8" data-aos="fade-up" data-aos-delay="200">
      ...
      <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8 text-left">
        <div class="bg-[#F2EFE7] p-6 rounded-xl shadow-lg card-hover" data-aos="fade-up" data-aos-delay="200">
          <h3 class="text-xl special-font font-semibold text-[#006A71] mb-2">
            <i class="fas fa-phone text-[#48A6A7]"></i> Prem Bhuvan
          </h3>
          <p class="text-[#2A4365] body-font">
            <i class="fas fa-phone-alt mr-2 text-[#006A71]"></i>Phone: 
            <a href="tel:+1234567890" class="text-[#1D63FF] hover:text-[#48A6A7]">+1 234 567 890</a>
          </p>
          <p class="text-[#2A4365] body-font">
            <i class="fas fa-envelope mr-2 text-[#006A71]"></i>Email: 
            <a href="mailto:bhuvan@example.com" class="text-[#1D63FF] hover:text-[#48A6A7]">bhuvan@example.com</a>
          </p>
        </div>
        <div class="bg-[#F2EFE7] p-6 rounded-xl shadow-lg card-hover" data-aos="fade-up" data-aos-delay="300">
          <h3 class="text-xl special-font font-semibold text-[#006A71] mb-2">
            <i class="fas fa-phone text-[#48A6A7]"></i> Pardhu
          </h3>
          <p class="text-[#2A4365] body-font">
            <i class="fas fa-phone-alt mr-2 text-[#006A71]"></i>Phone: 
            <a href="tel:+1987654321" class="text-[#1D63FF] hover:text-[#48A6A7]">+1 987 654 321</a>
          </p>
          <p class="text-[#2A4365] body-font">
            <i class="fas fa-envelope mr-2 text-[#006A71]"></i>Email: 
            <a href="mailto:pardhu@example.com" class="text-[#1D63FF] hover:text-[#48A6A7]">pardhu@example.com</a>
          </p>
        </div>
        <div class="bg-[#F2EFE7] p-6 rounded-xl shadow-lg card-hover" data-aos="fade-up" data-aos-delay="400">
          <h3 class="text-xl special-font font-semibold text-[#006A71] mb-2">
            <i class="fas fa-phone text-[#48A6A7]"></i> Bhargav
          </h3>
          <p class="text-[#2A4365] body-font">
            <i class="fas fa-phone-alt mr-2 text-[#006A71]"></i>Phone: 
            <a href="tel:+1123456789" class="text-[#1D63FF] hover:text-[#48A6A7]">+1 123 456 789</a>
          </p>
          <p class="text-[#2A4365] body-font">
            <i class="fas fa-envelope mr-2 text-[#006A71]"></i>Email: 
            <a href="mailto:bhargav@example.com" class="text-[#1D63FF] hover:text-[#48A6A7]">bhargav@example.com</a>
          </p>
        </div>
        <div class="bg-[#F2EFE7] p-6 rounded-xl shadow-lg card-hover" data-aos="fade-up" data-aos-delay="500">
          <h3 class="text-xl special-font font-semibold text-[#006A71] mb-2">
            <i class="fas fa-phone text-[#48A6A7]"></i> Rohit
          </h3>
          <p class="text-[#2A4365] body-font">
            <i class="fas fa-phone-alt mr-2 text-[#006A71]"></i>Phone: 
            <a href="tel:+1098765432" class="text-[#1D63FF] hover:text-[#48A6A7]">+1 098 765 432</a>
          </p>
          <p class="text-[#2A4365] body-font">
            <i class="fas fa-envelope mr-2 text-[#006A71]"></i>Email: 
            <a href="mailto:rohit@example.com" class="text-[#1D63FF] hover:text-[#48A6A7]">rohit@example.com</a>
          </p>
        </div>
      </div>
    </div>
  ...
  <div id="Popup" class="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50" style="display: none;">
  <div class="relative bg-white p-8 rounded-xl shadow-lg w-96 max-w-[90%] mx-auto">
    ...
    <div class="mt-6 text-center">
      <a href="signup.php"
         class="inline-block bg-[#006A71] hover:bg-[#48A6A7] text-white px-6 py-2 rounded-lg transition">
        Login / Sign Up
      </a>
    </div>
  </div>
