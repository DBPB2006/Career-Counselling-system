            ...
            <header class="bg-[#006A71] py-4">
                <div class="max-w-7xl mx-auto px-6 flex justify-between items-center">
                    ...
                    <nav class="hidden md:flex space-x-6 text-[#F2EFE7] text-sm font-medium">
                        ...
                        <a href="about.php" class="flex items-center gap-2 hover:text-[#9ACBD0] hover:border-b-2 hover:border-[#9ACBD0] active:border-b-2 active:border-[#9ACBD0] transition-all duration-700">
                            <i class="fas fa-info-circle"></i>
                            <span>About</span>
                        </a>
                        <a href="contact.php" class="flex items-center gap-2 hover:text-[#9ACBD0] hover:border-b-2 hover:border-[#9ACBD0] active:border-b-2 active:border-[#9ACBD0] transition-all duration-700">
