    ...
    <div class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300 transform hover:-translate-y-1">
        ...
        <div class="p-6">
            <div class="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mb-4">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-8 h-8 text-[#2973B2]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v5.172a2 2 0 00.586 1.414l5 5c1.26 1.26.367 3.414-1.415 3.414H4.828c-1.782 0-2.674-2.154-1.414-3.414l5-5A2 2 0 009 10.172V5L8 4z"></path>
                </svg>
            </div>
            <h3 class="text-2xl font-bold mb-2 text-gray-800">🎓 If You're from a Computer Science / IT Background</h3>
            <p class="text-gray-600 mb-6">
                If pursuing an IT background after graduation is a good idea . It can be a great move, depending on your interests and career goals. Here are some career paths.
            </p>
            <div class="mb-6">
            ...
            <button class="bg-[#2973B2] text-white px-4 py-2 rounded-md font-medium hover:bg-blue-600 transition-colors duration-200 w-full">
                Explore IT Stream
            </button>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300 transform hover:-translate-y-1">
        ...
        <div class="p-6">
            <div class="w-16 h-16 bg-green-100 rounded-full flex items-center justify-center mb-4">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-8 h-8 text-[#9ACBD0]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                </svg>
            </div>
            <h3 class="text-2xl font-bold mb-2 text-gray-800">📈 If You're Interested in Business + Tech</h3>
            <p class="text-gray-600 mb-6">
                If you enjoy understanding how businesses work and want to leverage tech to make things better, this combo can open doors in startups, big tech, finance, healthcare.Here are some career paths.
            </p>
            <div class="mb-6">
                <h4 class="font-semibold text-gray-700 mb-2">Career Paths:</h4>
                <ul class="list-disc pl-5 text-gray-600 space-y-1">
                    <li>MBA (General or with Tech focus)</li>
            ...
            <button class="bg-[#9ACBD0] text-white px-4 py-2 rounded-md font-medium hover:bg-green-600 transition-colors duration-200 w-full">
                Explore Business Stream
            </button>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300 transform hover:-translate-y-1">
        ...
        <div class="p-6">
            <div class="w-16 h-16 bg-purple-100 rounded-full flex items-center justify-center mb-4">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-8 h-8 text-[#48A6A7]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"></path>
                </svg>
            </div>
            <h3 class="text-2xl font-bold mb-2 text-gray-800">💼 Industry-Certified Paths </h3>
            <p class="text-gray-600 mb-6">
                Choosing the IT path after graduation can be a very smart move, even if your degree wasn't originally in tech.Here are some career paths.
            </p>
            <div class="mb-6">
                <h4 class="font-semibold text-gray-700 mb-2">Career Paths:</h4>
                <ul class="list-disc pl-5 text-gray-600 space-y-1">
            ...
            <button class="bg-[#48A6A7] text-white px-4 py-2 rounded-md font-medium hover:bg-purple-600 transition-colors duration-200 w-full">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div
                            ...
                            <div class="p-6">
                              ...
                              <a href="../exams/ugtest.php">  <button
