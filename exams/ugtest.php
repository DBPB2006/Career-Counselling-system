    ...
    <div class="max-w-7xl mx-auto px-6 flex justify-between items-center">
        ...
        <div class="flex items-center space-x-6">
            ...
            <nav class="flex space-x-6 items-center">
                ...
                <a href="../pages/grade.php" class="hover:text-[#9ACBD0] hover:border-b-2 hover:border-[#9ACBD0] active:border-b-2 active:border-[#9ACBD0] transition-all duration-700">Explore Grades</a>
            </nav>
